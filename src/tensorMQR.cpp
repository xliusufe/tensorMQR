...
{	
	...
	return List::create(Named("likhd") = likhd0, Named("Dnew") = Dnew, Named("A") = A, Named("B") = B, Named("C") = C,Named("S") = S);
}
//----------------------------------------------------------------**
//***--------------------updateV----------------------------------**
...
//----------------------------------------------------------------**
//***-------The derivative loass by penalizing U -----------------**
...
//----------------------------------------------------------------**
//***-------The derivative loass by penalizing d -----------------**
